...
<html>
	...
	<body>
		...
		<div class="col-sm-8">
			...
			<%--TODO06: you can also make your own tag libraries.
			          See SecurityTagLib in taglib (T0DO nr 8). --%>
			<sec:ifLoggedIn>
			
				<div class="jumbotron">
					<%-- TODO05: As you can see, this file is called index.gsp, the same as the action (index) in the controller.
					     ...
					     Below, you can see some of the variables given to the view in the controller.
					 --%>
			        ...
			        <h2>Collegues</h2>
			        <%-- TODO07: Normal HTML can be intertwined with Grails-specific tags, such as g:each.
